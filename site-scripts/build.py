...
def mkHead():
    page.write('<head>\n')
    page.write('<link rel="stylesheet" type="text/css" href="site-style/normalize.css">\n')
    page.write('<link rel="stylesheet" type="text/css" href="site-style/skeleton.css">\n')
    page.write('<link rel="stylesheet" type="text/css" href="site-style/style.css">\n')
    page.write('</head>\n')
